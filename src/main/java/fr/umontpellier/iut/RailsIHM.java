...
import fr.umontpellier.iut.vues.VuePiocheDestinations;
import fr.umontpellier.iut.vues.VueTable;
...
public class RailsIHM extends Application {
    ...
    public void demarrerPartie() {
        ...
        vueDuJeu = new VueTable(serviceDuJeu.getJeu());
